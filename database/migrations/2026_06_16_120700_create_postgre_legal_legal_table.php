...
return new class extends Migration
{
    ...
    {
        DB::statement(<<<'SQL'
CREATE TABLE IF NOT EXISTS "legal"."legal" (
    "legal_id" bigint GENERATED BY DEFAULT AS IDENTITY NOT NULL,
...
SQL);
    ...
    {
        DB::statement(<<<'SQL'
DROP TABLE IF EXISTS "legal"."legal" CASCADE
SQL);
    }
};
