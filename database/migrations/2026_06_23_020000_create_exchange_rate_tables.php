...
CREATE TABLE IF NOT EXISTS legal.exchange_rates (
    ...
    CONSTRAINT exchange_rates_valid_interval_check CHECK (valid_to IS NULL OR valid_to >= valid_from),
...
SQL);
        ...
        DB::statement('CREATE INDEX IF NOT EXISTS exchange_rates_lookup_idx ON legal.exchange_rates (provider, rate_type, currency_code, valid_from, valid_to)');
        ...
        DB::statement('CREATE INDEX IF NOT EXISTS exchange_rates_current_idx ON legal.exchange_rates (provider, rate_type, currency_code) WHERE valid_to IS NULL');
