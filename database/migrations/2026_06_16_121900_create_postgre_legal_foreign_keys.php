...
BEGIN
    IF NOT EXISTS (
        ...
        ALTER TABLE "legal"."bank_account"
            ADD CONSTRAINT "bank_account_ibfk_2" FOREIGN KEY (legal_id) REFERENCES legal.legal(legal_id);
    END IF;
END;
$$
SQL);
...
BEGIN
    IF NOT EXISTS (
        ...
        ALTER TABLE "legal"."legal_brand"
            ADD CONSTRAINT "legal_brand_ibfk_1" FOREIGN KEY (legal_id_owner) REFERENCES legal.legal(legal_id);
    END IF;
END;
$$
SQL);
...
BEGIN
    IF NOT EXISTS (
        ...
        ALTER TABLE "legal"."legal_buh_saldo"
            ADD CONSTRAINT "legal_buh_saldo_ibfk_1" FOREIGN KEY (legal_id) REFERENCES legal.legal(legal_id);
    END IF;
END;
$$
SQL);
...
BEGIN
    IF NOT EXISTS (
        ...
        ALTER TABLE "legal"."legal_buh_vat"
            ADD CONSTRAINT "legal_buh_vat_ibfk_2" FOREIGN KEY (legal_id) REFERENCES legal.legal(legal_id);
    END IF;
END;
$$
SQL);
...
BEGIN
    IF NOT EXISTS (
        ...
        ALTER TABLE "legal"."legal_reconciliation"
            ADD CONSTRAINT "legal_reconciliation_ibfk_2" FOREIGN KEY (legal_id) REFERENCES legal.legal(legal_id);
    END IF;
END;
$$
SQL);
...
BEGIN
    IF NOT EXISTS (
        ...
        ALTER TABLE "legal"."legal_tax"
            ADD CONSTRAINT "legal_tax_ibfk_1" FOREIGN KEY (legal_id) REFERENCES legal.legal(legal_id);
    END IF;
END;
$$
SQL);
...
BEGIN
    IF NOT EXISTS (
        ...
        ALTER TABLE "legal"."legal_tax_period"
            ADD CONSTRAINT "legal_tax_period_ibfk_1" FOREIGN KEY (legal_id) REFERENCES legal.legal(legal_id);
    END IF;
END;
$$
SQL);
