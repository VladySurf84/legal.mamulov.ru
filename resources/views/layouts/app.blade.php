...
@php
    $navItems = [
        ...
        ['label' => 'СГР', 'route' => 'nsi-sgr.index', 'active' => 'nsi-sgr.*', 'group' => 'Справочники'],
        ...
        ['label' => 'HH отклики', 'route' => 'hh-browser-captures.index', 'active' => 'hh-browser-captures.*', 'group' => 'Система'],
    ...
    $navItems = array_values(array_filter(
        ...
        fn (array $item): bool => match ($item['route']) {
            ...
            'nsi-sgr.index' => \App\Support\UserAccess::canViewNsiSgr(auth()->user()),
