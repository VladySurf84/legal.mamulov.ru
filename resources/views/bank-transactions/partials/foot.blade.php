<tr>
    ...
    <td class="sticky bottom-0 z-10 whitespace-nowrap border-t border-gray-300 bg-[var(--bank-income-bg)] px-3 py-3.5 text-right text-sm font-semibold tabular-nums text-emerald-700 backdrop-blur-sm backdrop-filter dark:border-white/15">
        {{ number_format($summary['income'], 2, ',', ' ') }}
    </td>
    <td class="sticky bottom-0 z-10 whitespace-nowrap border-t border-gray-300 bg-[var(--bank-expense-bg)] px-3 py-3.5 text-right text-sm font-semibold tabular-nums text-rose-700 backdrop-blur-sm backdrop-filter dark:border-white/15">
