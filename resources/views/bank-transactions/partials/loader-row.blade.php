<tr id="bank-transactions-loader-row" data-ui-sticky-table-loader-row @class(['hidden' => ! $nextPage])>
    <td class="h-[20vh] py-3 text-center align-middle text-sm text-slate-500" colspan="{{ $tableColspan }}">
        <div id="bank-transactions-loader" data-ui-sticky-table-loader data-next-page="{{ $nextPage }}">
